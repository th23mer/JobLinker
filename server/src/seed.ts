  ...
  try {
    ...
    const offres = [
      ...
      },
      {
        ...
        description: "Mission : mettre en place et maintenir les pipelines CI/CD.",
      ...
      },
      {
        ...
        description: "Participer aux missions d'audit et de contrôle financier.",
      ...
      },
      {
        ...
        description: "Gérer les réseaux sociaux et créer du contenu engageant.",
      ...
      },
      {
        ...
        description: "Analyser les données metier et produire des tableaux de bord.",
        exigences: "SQL, Power BI, Excel avancé, esprit analytique",
        type_contrat: "CDI",
        ville: "Tunis",
      ...
      },
      {
        ...
        description: "Concevoir et maintenir des applications mobiles performantes.",
      ...
      },
      {
        ...
        description: "Mettre en place les tests automatisés et garantir la qualité.",
      ...
      },
      {
        ...
        description: "Saisir les écritures comptables et participer aux clôtures mensuelles.",
      ...
      },
      {
        ...
        description: "Conduire des missions d'audit et proposer des plans d'amélioration.",
        exigences: "Audit, communication, normes de contrôle interne",
        type_contrat: "CDI",
        ville: "Tunis",
        experience_requise: "3-5 ans",
        niveau_etude: "Master",
      ...
      },
      {
        ...
        description: "Piloter des campagnes Meta et Google Ads.",
      ...
      },
      {
        ...
        description: "Animer les réseaux sociaux et créer un calendrier editorial.",
        exigences: "Canva, TikTok, Instagram, rédaction",
        type_contrat: "Stage",
        ville: "Sfax",
        experience_requise: "0-1 an",
        niveau_etude: "Licence",
      ...
      },
      {
        ...
        description: "Suivi de chantier, coordination des équipes techniques.",
      ...
      {
        titre: "Technicien Maintenance Mécanique",
        description: "Assurer la maintenance préventive et corrective des équipements.",
      ...
      {
        titre: "Chargé(e) de Recrutement IT",
        description: "Identifier et qualifier des profils tech.",
      ...
      },
      {
        ...
        description: "Construire des parcours de formation et mesurer l'impact.",
        exigences: "Ingénierie pédagogique, animation, LMS",
        type_contrat: "CDI",
        ville: "Tunis",
      ...
      },
      {
        ...
        description: "Assurer les consultations de médecine générale.",
        exigences: "Doctorat en médecine, inscription à l'ordre",
        type_contrat: "CDI",
        ville: "Monastir",
      ...
      },
      {
        ...
        description: "Conseil patient, gestion des stocks et suivi réglementaire.",
        exigences: "Diplôme de pharmacie, sens du service",
        type_contrat: "CDI",
        ville: "Mahdia",
        experience_requise: "1-3 ans",
        niveau_etude: "Doctorat",
