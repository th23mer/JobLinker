...
async function seed() {
  ...
  try {
    ...
    const recruteurs = [
      ...
      {
        nom_entreprise: "NeoBank Tunisia",
        matricule_fiscal: "NB901234",
        adresse: "Tunis, Lac 2",
        description: "Fintech specialisee dans les services bancaires digitaux",
        statut_validation: "validee",
        email: "talents@neobank.tn",
        telephone: "+216 71 000 004",
        nom_representant: "Masmoudi",
        prenom_representant: "Rim",
      },
      {
        nom_entreprise: "MedCare Group",
        matricule_fiscal: "MC567890",
        adresse: "Monastir, zone clinique",
        description: "Groupe sante prive engage sur la qualite des soins",
        statut_validation: "validee",
        email: "rh@medcare.tn",
        telephone: "+216 73 000 005",
        nom_representant: "Khelifi",
        prenom_representant: "Sami",
      },
    ];
    ...
    const offres = [
      ...
      },
      {
        ...
        description:
          "Analyser les donnees metier et produire des tableaux de bord pour le pilotage des performances.",
        exigences: "SQL, Power BI, Excel avance, esprit analytique",
        type_contrat: "CDI",
        ville: "Tunis",
      ...
      {
        titre: "Developpeur Mobile Flutter",
        description:
          "Concevoir et maintenir des applications mobiles performantes pour le marche tunisien.",
        exigences: "Flutter, Dart, REST API, Firebase",
        type_contrat: "CDI",
        ville: "Sousse",
        experience_requise: "2-4 ans",
        niveau_etude: "Licence",
        categorie_id: 1,
        specialite_id: 2,
        statut_validation: "validee",
      ...
      {
        titre: "Ingenieur QA Automatisation",
        description:
          "Mettre en place les tests automatises et garantir la qualite des livrables produit.",
        exigences: "Cypress, Playwright, CI/CD, testing strategy",
        type_contrat: "CDI",
        ville: "Tunis",
        experience_requise: "2-3 ans",
      ...
      {
        titre: "Assistant(e) Comptable",
        description:
          "Saisir les ecritures comptables et participer aux clotures mensuelles.",
        exigences: "Sage, rigueur, notions fiscales tunisiennes",
        type_contrat: "CDD",
        ville: "Sfax",
        experience_requise: "0-1 an",
        niveau_etude: "Licence",
      ...
      {
        titre: "Consultant Audit Interne",
        description:
          "Conduire des missions d'audit et proposer des plans d'amelioration des controles internes.",
        exigences: "Audit, communication, normes de controle interne",
        type_contrat: "CDI",
        ville: "Tunis",
        experience_requise: "3-5 ans",
        niveau_etude: "Master",
      ...
      {
        titre: "Specialiste Marketing Digital",
        description:
          "Piloter des campagnes Meta et Google Ads avec objectifs de conversion.",
        exigences: "Google Ads, Meta Ads, GA4, copywriting",
        type_contrat: "CDI",
        ville: "Sousse",
        experience_requise: "2-3 ans",
        niveau_etude: "Licence",
      ...
      {
        titre: "Community Manager Junior",
        description:
          "Animer les reseaux sociaux et creer un calendrier editorial engageant.",
        exigences: "Canva, TikTok, Instagram, redaction",
        type_contrat: "Stage",
        ville: "Sfax",
        experience_requise: "0-1 an",
        niveau_etude: "Licence",
      ...
      {
        titre: "Ingenieur Genie Civil",
        description:
          "Suivi de chantier, coordination des equipes techniques et controle de conformite.",
        exigences: "AutoCAD, MS Project, suivi chantier",
        type_contrat: "CDI",
        ville: "Nabeul",
      ...
      },
      {
        ...
        description:
          "Assurer la maintenance preventive et corrective des equipements industriels.",
        exigences: "Pneumatique, hydraulique, lecture de plans",
        type_contrat: "CDD",
        ville: "Sousse",
      ...
      {
        titre: "Charge(e) de Recrutement IT",
        description:
          "Identifier et qualifier des profils tech pour des besoins nationaux et internationaux.",
        exigences: "Sourcing LinkedIn, entretiens, ATS",
        type_contrat: "CDI",
        ville: "Tunis",
        experience_requise: "2-4 ans",
        niveau_etude: "Master",
      ...
      },
      {
        ...
        description:
          "Construire des parcours de formation et mesurer l'impact des plans de developpement.",
        exigences: "Ingenierie pedagogique, animation, LMS",
        type_contrat: "CDI",
        ville: "Tunis",
      ...
      {
        titre: "Medecin Generaliste",
        description:
          "Assurer les consultations de medecine generale en clinique privee.",
        exigences: "Doctorat en medecine, inscription a l'ordre",
        type_contrat: "CDI",
        ville: "Monastir",
      ...
      {
        titre: "Pharmacien(ne) Officine",
        description:
          "Conseil patient, gestion des stocks et suivi reglementaire de l'officine.",
        exigences: "Diplome de pharmacie, sens du service",
        type_contrat: "CDI",
        ville: "Mahdia",
        experience_requise: "1-3 ans",
        niveau_etude: "Doctorat",
