...
async function seed() {
  ...
  try {
    ...
    // ── Candidatures (35) ──
    const sampleLetters = [
      "Bonjour,\n\nVotre annonce a immédiatement attiré mon attention. Mon parcours de plusieurs années sur des stacks similaires, ainsi que mon goût prononcé pour les produits orientés utilisateur, font que je serais ravi(e) de contribuer à votre équipe.\n\nJe reste à votre disposition pour échanger sur la suite.\n\nCordialement,",
      "Madame, Monsieur,\n\nFortement intéressé(e) par le poste, je pense pouvoir apporter une vraie valeur grâce à mon expérience récente sur des projets comparables. La mission proposée correspond exactement à mes ambitions actuelles.\n\nJe serais heureux(se) d'en discuter lors d'un entretien.",
      "Bonjour,\n\nJe candidate à votre offre car votre culture d'entreprise et la mission proposée résonnent fortement avec mes valeurs. J'aime résoudre des problèmes concrets et j'apprécie particulièrement l'attention que vous portez à la qualité.\n\nMerci d'avance pour votre attention.",
      "Bonjour,\n\nDiplômé(e) récemment, je suis très motivé(e) à rejoindre une équipe comme la vôtre où je pourrai monter en compétences rapidement tout en livrant des résultats concrets dès les premiers mois.\n\nÀ très bientôt, je l'espère.",
      "Madame, Monsieur,\n\nForte de plusieurs expériences pertinentes, je vous adresse ma candidature pour ce poste. Je suis particulièrement sensible à votre approche centrée sur le client, et serais honorée de pouvoir y contribuer.\n\nBien à vous,",
    ];
    const candidatures = [
      { candidat_id: 1,  offre_emploi_id: 1,  statut: "en_attente", letter: 0 },
      { candidat_id: 1,  offre_emploi_id: 2,  statut: "acceptee",   letter: 1 },
      { candidat_id: 1,  offre_emploi_id: 8,  statut: "en_attente", letter: 2 },
      { candidat_id: 2,  offre_emploi_id: 14, statut: "en_attente", letter: 4 },
      { candidat_id: 2,  offre_emploi_id: 17, statut: "refusee",    letter: 1 },
      { candidat_id: 2,  offre_emploi_id: 19, statut: "en_attente", letter: 2 },
      { candidat_id: 3,  offre_emploi_id: 2,  statut: "refusee",    letter: 0 },
      { candidat_id: 3,  offre_emploi_id: 7,  statut: "acceptee",   letter: 0 },
      { candidat_id: 3,  offre_emploi_id: 11, statut: "en_attente", letter: 1 },
      { candidat_id: 4,  offre_emploi_id: 21, statut: "en_attente", letter: 3 },
      { candidat_id: 4,  offre_emploi_id: 24, statut: "en_attente", letter: 2 },
      { candidat_id: 5,  offre_emploi_id: 27, statut: "acceptee",   letter: 1 },
      { candidat_id: 5,  offre_emploi_id: 28, statut: "en_attente", letter: 0 },
      { candidat_id: 5,  offre_emploi_id: 29, statut: "en_attente", letter: 2 },
      { candidat_id: 6,  offre_emploi_id: 33, statut: "en_attente", letter: 4 },
      { candidat_id: 6,  offre_emploi_id: 34, statut: "refusee",    letter: 1 },
      { candidat_id: 7,  offre_emploi_id: 5,  statut: "acceptee",   letter: 0 },
      { candidat_id: 7,  offre_emploi_id: 6,  statut: "en_attente", letter: 0 },
      { candidat_id: 8,  offre_emploi_id: 49, statut: "en_attente", letter: 2 },
      { candidat_id: 8,  offre_emploi_id: 50, statut: "acceptee",   letter: 4 },
      { candidat_id: 8,  offre_emploi_id: 52, statut: "en_attente", letter: 1 },
      { candidat_id: 9,  offre_emploi_id: 38, statut: "en_attente", letter: 3 },
      { candidat_id: 9,  offre_emploi_id: 40, statut: "acceptee",   letter: 4 },
      { candidat_id: 10, offre_emploi_id: 16, statut: "en_attente", letter: 0 },
      { candidat_id: 10, offre_emploi_id: 18, statut: "en_attente", letter: 1 },
      { candidat_id: 11, offre_emploi_id: 10, statut: "en_attente", letter: 0 },
      { candidat_id: 11, offre_emploi_id: 11, statut: "refusee",    letter: 1 },
      { candidat_id: 12, offre_emploi_id: 44, statut: "en_attente", letter: 2 },
      { candidat_id: 12, offre_emploi_id: 46, statut: "acceptee",   letter: 4 },
      { candidat_id: 13, offre_emploi_id: 53, statut: "en_attente", letter: 3 },
      { candidat_id: 13, offre_emploi_id: 55, statut: "en_attente", letter: 2 },
      { candidat_id: 14, offre_emploi_id: 37, statut: "acceptee",   letter: 4 },
      { candidat_id: 14, offre_emploi_id: 41, statut: "en_attente", letter: 0 },
      { candidat_id: 15, offre_emploi_id: 11, statut: "en_attente", letter: 1 },
      { candidat_id: 15, offre_emploi_id: 12, statut: "en_attente", letter: 2 },
    ];
    for (const ca of candidatures) {
      await client.query(
        `INSERT INTO candidature (candidat_id, offre_emploi_id, statut, lettre_motivation) VALUES ($1, $2, $3, $4)`,
        [ca.candidat_id, ca.offre_emploi_id, ca.statut, sampleLetters[ca.letter]]
      );
    }
